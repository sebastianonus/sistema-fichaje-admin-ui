...
export const TEXTS = {
  ...
  workerPortal: {
    ...
    status: {
      ...
      gpsMissingWarning: 'No se pudo obtener la ubicacion. Es obligatoria para entradas, inicios de pausa, finales de pausa y salidas.',
    },
    actions: {
      clockIn: 'Entrada',
      breakStart: 'Inicio pausa',
    ...
    errors: {
      ...
      gpsRequired: 'No se pudo obtener tu ubicacion. Activa permisos y espera a que el GPS se cargue antes de registrar el evento.',
    },
  },
  ...
  incidencias: {
    ...
    actions: {
      ...
      openIncident: 'Ver incidencia',
      correctNow: 'Corregir ahora',
      resolve: 'Marcar como resuelta',
    },
    resolveModal: {
      title: 'Marcar incidencia como resuelta',
      description: 'Usa esta accion cuando el fichaje ya esta corregido o revisado y solo falta cerrar la incidencia.',
      note: 'Nota de resolucion',
      notePlaceholder: 'Ej. Fichaje corregido y jornada revisada',
  ...
  trabajadores: {
    ...
    errors: {
      ...
      emailMissing: 'No se pudo abrir el correo porque falta el email del trabajador.',
  ...
  workerDetail: {
    ...
    correction: {
      ...
      incidentResolvedBadge: 'Incidencia resuelta',
      ...
      modalIncidentContext: 'Datos de la incidencia',
      incidentCloseOutBadge: 'Salida de incidencia',
      closesIncidentFromLabel: 'Cierra incidencia iniciada:',
    },
    location: {
      label: 'Ubicacion:',
      noData: 'Sin GPS',
    ...
    incidents: {
      ...
      resolve: 'Marcar como resuelta',
      resolvedSuccess: 'Incidencia marcada como resuelta.',
    },
    filters: {
