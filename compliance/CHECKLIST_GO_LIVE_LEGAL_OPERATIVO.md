...
- [x] Se registra entrada y salida diaria por trabajador.
- [x] El registro es objetivo, fiable y accesible.
- [x] Existe trazabilidad de cambios/correcciones (sin borrado oculto).
- [x] Los registros se conservan 4 anos.
- [x] Hay procedimiento para poner registros a disposicion de Inspeccion.
...
- [x] Medidas de seguridad activas (credenciales, logs, backups, cifrado en transito).
